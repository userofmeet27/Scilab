...
subplot(4 ,1 ,2) ; xgrid;
a=gca() ;
a.x_location = "origin"; a.y_location = "origin"; a.foreground = 4; hx=0:length(h)-1 plot2d3(h);
...
a.y_location = "origin"; 
a.foreground = 4; 
clinx=0:length(clin)-1 plot2d3(clin);
...
a.y_location = "origin"; 
a.foreground = 4; 
ccircx=0:length(ccirc)-1 plot2d3(ccirc);
